...
search_categories = ['math.HO', 'math.GM','math.NT', 'eess.SP', 'cs.GT', 'cs.CC', 'cs.CR', 'cs.LG', 'eess.SY']
...
## TODO: redo this function as its WRONG. debug code is still in the program btw.
...
for _cat in search_categories:
    ...
    print(_r.text, type(_r.text))
    print()
    print()
    new_papers = arxiv_atom_parser(_r.text)

    print(new_papers, type(new_papers))
    quit()
